        ...
        <>
            ...
            <div className="flex flex-row justify-center items-center min-h-screen m-auto py-40 font-body">
                <div className="flex flex-col justify-center items-center sm:items-start w-8/12 sm:w-full md:w-1/2 text-center sm:text-left">
                    ...
                    <div className="mt-12">
                        <button className="space-x-2 flex justify-center items-center text-[#183D3D] text-lg font-medium  border-4 border-[#183D3D] py-2 px-4 hover:text-[#93B1A6] hover:border-[#93B1A6]">
                            <SVG Icon={RightArrow} />
                            <p>Experience</p>
                        </button>
                    </div>
